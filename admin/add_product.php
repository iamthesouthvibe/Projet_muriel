    ...
    <form method="POST" enctype="multipart/form-data" id="form" name="form">
      <div class="form_addtours_top">
        <div class="form-control">
          ...
          <br>
          <input type="text" name="nom" value="<?= (isset($toEditID)) ? '' . $rows['name_p'] . '' : ''; ?>" placeholder="nom" id="nom">
          <br>
        ...
        <div class="form-control">
          ...
          <br>
          <input type="text" name="description" id="description" value="<?= (isset($toEditID)) ? '' . $rows['description_p'] . '' : ''; ?>" placeholder="event topic">
          <br>
          <small>Error Message</small>
        </div>
        ...
        <div class="form-control">
          ...
          <br>
          <input type="text" id="size" name="size" value="<?= (isset($toEditID)) ? '' . $rows['size_p'] . '' : ''; ?>" placeholder="venue">
          <br>
          <small>Error Message</small>
        </div>
